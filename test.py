...
# CSS Personalizado para tema CLARO, amigable y corregir el color del texto del botón principal a negro.
st.markdown("""
<style>
...
def scroll_to_top():
    ...
    st.markdown("""
        ...
        """, unsafe_allow_html=True)
    # NOTA: st.experimental_rerun() estaba aquí en algunas versiones, pero no es necesario para scroll.
